% a demo of Matlab functions for classic neural data analysis
% 
...
% fourth argument = 1 (0/1, default:0) saves trial-to-trial data.
% this is by default off to save disk space and running speed.
...
% if you just want to compute psth without plotting
