...
% combine mat results files. generalized from combine_psths
%  2019 HRK
...
%             warning('%s is not valid psth. may want to exclude it', fn{iFD});
%             continue;
%         end
