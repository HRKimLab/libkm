...
## [libpopulation](https://github.com/hkim09/libkm/tree/release---NM/libpopulation)
Plot data with relevant statistical tests.

## [libtimeseries](https://github.com/hkim09/libkm/tree/release---NM/libtimeseries)
Plot time course and save the results. Combime the results and plot population time courses.

## [libbigtable](https://github.com/hkim09/libkm/tree/release---NM/libbigtable)
Save individual-session analysis results. Load discrete population data into a big table.

## [libutil](https://github.com/hkim09/libkm/tree/release---NM/libutil)
A collection of misc functions.

## [libfit](https://github.com/hkim09/libkm/tree/release---NM/libfit)
A function which is used for fitting.
