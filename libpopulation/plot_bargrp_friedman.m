function [grp_means grp_sem pRef pDiff mc_sig gR gP bar_res] = plot_bargrp(y, grp, varargin)
% plot_barplot 
...
% 2017 HRK 2023 Jongwon modified for friedman test.
...
for i=bar_x
    barg=bar(bar_x(i),grp_means(i));
    hold on;
end

set(gca,'xtick',[1:numel(bar_x)]);
...
if show_individual
    ...
    bar_res.hScatter1 = hS1;
    bar_res.hScatter2 = hS2;
else
    hS = [];
end
...
% for plot_barpair_grp selective star display
bar_res.pPair = pPair;
